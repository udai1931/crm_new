  ...
  return (
    <>
      <div className="flex flex-col flex-wrap sm:flex-row">
        {
          deps.map((dep) => (
            <div className="pr-2 mb-6 w-1/8" onClick={() => setCurDep(dep.name)}>
              <div className={dep.name == curDep ? "shadow rounded-2xl p-4 bg-white dark:bg-gray-800" : "shadow rounded-2xl p-4 bg-gray-200 dark:bg-gray-800"} >
      ...
      <div className="flex flex-col flex-wrap sm:flex-row">
        <div className="relative w-full p-4 mt-8 overflow-hidden bg-white shadow-lg rounded-xl md:w-4/12 md:ml-4 dark:bg-gray-800">
          ...
          <div className="flex items-center justify-between mb-6 rounded">
            ...
            <div className="flex items-center justify-between w-full">
              <div className="flex flex-col items-start justify-between w-full ml-2 mr-2 text-sm">
        ...
        <div className="relative w-full p-4 mt-8 overflow-hidden bg-white shadow-lg rounded-xl md:w-3/12 md:mr-2 dark:bg-gray-800">
              ...
              <div className="relative">
                <a href="#" className="relative block">
                  <img
                    alt="Jonathan Ilunga"
                    src="/images/4.jpg"
                    className="object-cover w-10 h-10 rounded-full mx4auto "
                  />
                </a>
                <svg
                  width="10"
        ...
        <div className="relative w-full p-4 mt-8 overflow-hidden text-gray-700 bg-white shadow-lg rounded-xl md:w-4/12 md:ml-2 dark:bg-gray-800">
